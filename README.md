...
git clone https://github.com/RzLModz/dosweb
cd RzLModz
npm i requests
...
RzLModz (ADD NEW PROXY)
```

# TOS:
```sh
Do not attack government pages (.gov/.gob/go.id), educational pages (.edu/sch.id) or the United States Department of Defense (.mil), 
...
# CONTACT:
```sh
Telegram: @Errorsystem404html
Whatsapp: +6288286813224
```
